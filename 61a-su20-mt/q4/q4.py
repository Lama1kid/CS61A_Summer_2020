...
def lemon(xv):
    ...
    False
    """
    # to avoid infinite recursion that might be caused by self-reference, I could keep track of objects that have already been copied.
    lemon_lookup = []
    def helper(xv):
        if isinstance(xv[0], int):
            return xv[0]
