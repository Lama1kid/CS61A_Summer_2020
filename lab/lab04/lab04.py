...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    fake_city = make_city('fake city', lat, lon)
    if distance(fake_city, city_a) < distance(fake_city, city_b):
        return get_name(city_a)
    elif distance(fake_city, city_a) > distance(fake_city, city_b): 
...
def add_chars(w1, w2):
    ...
    if w1 == '':
        ...
        return add_chars(w1[0], add_chars(w1[1:], w2))
    # you know somethimes giving you a break makes life much easier
