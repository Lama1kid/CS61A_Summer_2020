...
class CallExpr(Expr):
    ...
    def eval(self, env):
        ...
        for operand in self.operands:
            operands_value.append(operand.eval(env))
        return operator_value.apply(operands_value)
...
class LambdaFunction(Value):
    ...
    def apply(self, arguments):
        ...
        # binding arguments to formal parameters
        env = self.parent.copy()
        bindings = zip(self.parameters, arguments)
